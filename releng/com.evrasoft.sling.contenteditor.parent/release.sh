...
projectName="com.evrasoft.sling.contenteditor"
releaseDir="$projectName.releases"
updatesiteDir="$projectName.updatesite"

echo "Building target platform"
cd ../../releng/com.evrasoft.sling.contenteditor.repository.parent && mvn package
cd ../com.evrasoft.sling.contenteditor.parent/
