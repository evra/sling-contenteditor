...
2. Prepare target platform - go to /releng/com.evrasoft.sling.contenteditor.repository.parent and run mvn package
3. Generate CND source files - got to /releng/com.evrasoft.sling.contenteditor.parent and run mvn
...
5. Add target platform 
	...
	* Select folder {projectRoot}/releng/com.evrasoft.sling.contenteditor.repository/target/repository/
